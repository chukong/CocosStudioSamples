...
void CocosGUIExamplesWeaponScene::onEnter()
{
    ...
    exit_button->addReleaseEvent(this, coco_releaseselector(CocosGUIExamplesWeaponScene::menuCloseCallback));
...
void CocosGUIExamplesWeaponScene::menuCloseCallback(CCObject* pSender)
{
...
{    
    ...
    for (int i = 0; i < rowMax; ++i)
    {
        ...
        for (int j = 0; j < columnMax; ++j)
        {
            ...
            float width = item->getSize().width;
            float height = item->getSize().height;
            ...
            weapon->loadTexture(CCString::createWithFormat("cocosgui/gui_examples/weapon_introduce_1/weapon_item_1/weapons/weapons_%d.png",
                                                          index + 1)->getCString());
...
void CocosGUIExamplesWeaponScene::BuyLogic(CCObject *pSender)
{
    ...
    weapon_imageview->loadTexture(CCString::createWithFormat("cocosgui/gui_examples/weapon_introduce_1/weapon_item_1/weapons/weapons_%d.png",
