...
/*
#include "CocosGUIExamplesStartScene.h"
...
void CocosGUIExamplesRegisterScene::onEnter()
{
    ...
    passwordAgin_textfield->setPasswordEnabled(true);
    passwordAgin_textfield->setPasswordStyleText("*");
...
//    back_button->addReleaseEvent(this, coco_releaseselector(CocosGUIExamplesRegisterScene::toCocosGUIExamplesStartScene));
    ...
    exit_button->addReleaseEvent(this, coco_releaseselector(CocosGUIExamplesRegisterScene::menuCloseCallback));
...
void CocosGUIExamplesRegisterScene::menuCloseCallback(CCObject* pSender)
{
...
void CocosGUIExamplesRegisterScene::toCocosGUIExamplesStartScene(CCObject *pSender)
{
    CocosGUIExamplesStartScene* pScene = new CocosGUIExamplesStartScene();
    pScene->runThisTest();
    pScene->release();
}
